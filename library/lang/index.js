...
var translations = Object.assign({}, require('./' + config.lang + '/placeholders'), require('./' + config.lang + '/tips'), require('./' + config.lang + '/validation'), require('./' + config.lang + '/warnings'), require('./' + config.lang + '/text'));
